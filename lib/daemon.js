...
var relay = createServer({
  ...
  allowAutoMode: (config.windmills && config.windmills.allowAutoMode) !== false,  // windmills: allowAutoMode
  allowClaudeGuiModelPicker: (config.windmills && config.windmills.allowClaudeGuiModelPicker) !== false,  // windmills: allowClaudeGuiModelPicker
  ...
  onGetDaemonConfig: function () {
    return {
      ...
      windmills: config.windmills || {},  // windmills: expose the windmills.* namespace to all config consumers
    };
  },
  ...
  onSetWindmillsSetting: function (key, value) { config.windmills = config.windmills || {}; config.windmills[key] = value; saveConfig(config); return { ok: true, windmills: config.windmills }; },  // windmills
  onShutdown: function () {

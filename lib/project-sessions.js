...
function attachSessions(ctx) {
  ...
  function handleSessionsMessage(ws, msg) {
    ...
    if (msg.type === "get_daemon_config" || msg.type === "set_pin" || msg.type === "set_keep_awake" ||
        msg.type === "set_windmills_setting" ||  // windmills
    ...
    if (msg.type === "set_windmills_setting") { if (typeof opts.onSetWindmillsSetting === "function") { var wr = opts.onSetWindmillsSetting(msg.key, msg.value); sendTo(ws, { type: "set_windmills_setting_result", ok: wr.ok, windmills: wr.windmills }); send({ type: "windmills_changed", windmills: wr.windmills }); } return true; }  // windmills

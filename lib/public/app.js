...
import { initServerSettings, updateSettingsStats, updateSettingsModels } from './modules/server-settings.js';
...
// --- DOM refs ---
  ...
  function blinkIO() {
    ...
    ioTimer = setTimeout(function () { var d = getStatusDot(); if (d) d.classList.remove("io"); }, 60);
  ...
  initServerSettings({
    ...
    set currentModels(v) { currentModels = v; },

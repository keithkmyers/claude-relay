...
// --- DOM refs ---
  ...
  function renderAvailableBuiltins(builtins) {
    var section = document.querySelector(".dm-user-picker-builtin-section");
    if (!section) return;
    section.innerHTML = "";
    ...
    label.className = "dm-user-picker-section";
    label.textContent = "Add Built-in Mate";
  ...
  function ensureScheduledBubbleAtBottom() {
    if (scheduledMsgEl && scheduledMsgEl.parentNode === messagesEl) {
  ...
  function processMessage(msg) {
      ...
      switch (msg.type) {
        ...
        case "mate_available_builtins":
          renderAvailableBuiltins(msg.builtins || []);
          break;

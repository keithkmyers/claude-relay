...
import { handleWindmillsChanged } from './server-settings.js';  // windmills
...
export function processMessage(msg) {
    ...
    switch (msg.type) {
      ...
      case "info":
        ...
        if (msg.allowAutoMode !== undefined) store.set({ allowAutoMode: !!msg.allowAutoMode });  // windmills: allowAutoMode
        if (msg.allowClaudeGuiModelPicker !== undefined) store.set({ allowClaudeGuiModelPicker: !!msg.allowClaudeGuiModelPicker });  // windmills: allowClaudeGuiModelPicker
      ...
      case "set_windmills_setting_result":  // windmills
      case "windmills_changed":  // windmills
        handleWindmillsChanged(msg);  // windmills
        break;  // windmills

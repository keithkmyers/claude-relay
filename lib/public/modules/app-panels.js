...
var MODE_AUTO = { value: "auto", label: "Auto" };  // windmill: allowAutoMode
...
function modeDisplayName(value) {
  ...
  if (value === "auto") return "Auto";  // windmill: allowAutoMode
...
function rebuildModeList() {
  ...
  if (store.get('allowAutoMode')) options.push(MODE_AUTO);  // windmill: allowAutoMode

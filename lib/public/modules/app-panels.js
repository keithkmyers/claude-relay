...
var MODE_AUTO = { value: "auto", label: "Auto" };  // windmills: allowAutoMode
...
function modeDisplayName(value) {
  ...
  if (value === "auto") return "Auto";  // windmills: allowAutoMode
...
function rebuildModelList() {
  ...
  var hideModelPicker = s.activeSessionMode === "gui" && vendor === "claude" && !s.allowClaudeGuiModelPicker;
...
function rebuildModeList() {
  ...
  if (store.get('allowAutoMode')) options.push(MODE_AUTO);  // windmills: allowAutoMode

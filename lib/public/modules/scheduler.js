...
function setupCreateModal() {
  ...
  if (iendAfterInput) {
    ...
    iendAfterInput.addEventListener("keydown", function (e) { e.stopPropagation(); });
    iendAfterInput.addEventListener("keyup", function (e) { e.stopPropagation(); });
    iendAfterInput.addEventListener("keypress", function (e) { e.stopPropagation(); });
  }
  ...
  if (iendTimeInput) {
    ...
    iendTimeInput.addEventListener("keydown", function (e) { e.stopPropagation(); });
  }

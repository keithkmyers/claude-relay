...
function createServer(opts) {
  ...
  var allowAutoMode = opts.allowAutoMode !== false;  // windmills: allowAutoMode
  var allowClaudeGuiModelPicker = opts.allowClaudeGuiModelPicker !== false;  // windmills: allowClaudeGuiModelPicker
  ...
  var onSetWindmillsSetting = opts.onSetWindmillsSetting || null;  // windmills
  ...
  function addProject(cwd, slug, title, icon, projectOwnerId, worktreeMeta, extraOpts) {
    ...
    var ctx = createProjectContext({
      ...
      allowAutoMode: allowAutoMode,  // windmills: allowAutoMode
      allowClaudeGuiModelPicker: allowClaudeGuiModelPicker,  // windmills: allowClaudeGuiModelPicker
      osUsers: osUsers,
      ...
      onSetWindmillsSetting: onSetWindmillsSetting,  // windmills

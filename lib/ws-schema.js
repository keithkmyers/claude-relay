...
var schema = {
  ...
  "set_windmills_setting":        { direction: "c2s", handler: "lib/project-sessions.js", description: "Set a windmills.* daemon config toggle" },  // windmills
  "set_windmills_setting_result": { direction: "s2c", handler: "lib/public/modules/app-messages.js", description: "Windmills setting result (echoes windmills.*)" },  // windmills
  "windmills_changed":            { direction: "s2c", handler: "lib/public/modules/app-messages.js", description: "Broadcast: windmills.* state changed" },  // windmills
